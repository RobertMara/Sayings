...
class SayingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create saying" do
    assert_difference('Saying.count') do
      post sayings_url, params: { saying: { body: @saying.body, sayer_id: @saying.sayer_id } }
    end
  ...
  test "should update saying" do
    patch saying_url(@saying), params: { saying: { body: @saying.body, sayer_id: @saying.sayer_id } }
